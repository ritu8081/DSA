<h2><a href="https://practice.geeksforgeeks.org/problems/sort-a-stack/1?page=1&difficulty[]=1&category[]=Stack&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Sort a stack</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a stack, the task is to sort&nbsp;it such that the top of the stack has the greatest&nbsp;element.</span></p>
